/* Bundled dashboard script — migrated from the classic inline `<script>`
   ...
   Kept as a single module because the 247 declarations coexisted as
   globals in the original script and rewriting every cross-call to an
   explicit import/export was out of scope for this PR. Further
   region-level splitting (see notes/implicit-globals.md) is a safe

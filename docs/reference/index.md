...
description: Exhaustive lookup for every command, config key, README field, mutation, shortcut, env var, and HTTP route.
---
...
- **[HTTP and WebSocket API](http-api.md)** — the routes the embedded server exposes.
- **[Keyboard shortcuts](shortcuts.md)** — dashboard-wide and terminal-specific.
- **[Environment variables](env.md)** — the short list.
- **[Management skill](skill.md)** — the shipped `/conception-items` skill for Claude Code.
